...
![Temporal variation of reflectance and AOD across different satellite sensors  (Nazeer et al., 2021)](img/W3_1.png){width="70%"}
...
![Validation of estimated surface reflectance against reference data across spectral bands  (Nazeer et al., 2021)](img/W3_2.png){width="70%"}
